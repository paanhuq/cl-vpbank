              ...
              var Rive = (() => {
                ...
                return function(moduleArg = {}) {
                  ...
                  l.onRuntimeInitialized = function() {
                    ...
                    l.computeAlignment = function(f, g, k, p, n = 1) {
                      ...
                      if (a()) {
                        ...
                        if (b.canvas) {
                          ...
                          for (const K of r) {
                            ...
                            K.ic ? (b.scissor(K.Za, L - K.$a - K.jb, K.vc, K.jb), V = true) : V && (b.scissor(0, L - u, m, u), V = false);
                            r = 2 / m;
                            const aa = -2 / u;
                  ...
                  l.onRuntimeInitialized = function() {
                    ...
                    var u = l.RenderImage.extend("CanvasRenderImage", { __construct: function({ la: q, wa: v } = {}) {
                      ...
                      this.ja = { xb: q, yb: v, cb: J, eb: G, Qa: [], bc: true };
                    ...
                    l.RendererWrapper.prototype.align = function(q, v, J, G, A = 1) {
                  ...
                  function Zb(a, b = -1) {
                    var _a2, _b;
                    a = Yb(a, b);
                    (_b = (_a2 = a.m) == null ? void 0 : _a2.Kc) == null ? void 0 : _b.call(_a2, a);
                    return a;
                  }
                  var Db = { open(a) {
                    var _a2, _b;
                  ...
                  function jc(a, b, c) {
                    ...
                    b &= -131713;
                    e = Yb({ node: e, path: Sb(e), flags: b, seekable: true, position: 0, m: e.m, uc: [], error: false });
                    e.m.open && e.m.open(e);
                    !l.logReadFiles || b & 1 || (kc || (kc = {}), a in kc || (kc[a] = 1));
                    return e;
                  }
                  function lc(a, b, c) {
                    if (null === a.X) {
                  ...
                  var ee = { __syscall_fcntl64: function(a, b, c) {
                    ...
                    c = S(c);
                    Uc(a, { name: c, fromWireType: d, argPackAdvance: 8, readValueFromPointer: d }, { Xb: true });
                    ...
                    b = S(b);
                    Uc(a, { Oc: true, name: b, argPackAdvance: 0, fromWireType: () => {
                    }, toWireType: () => {
                    } });
                    ...
                    function a(c) {
                      ...
                      Qa--;
                      (_a3 = l.monitorRunDependencies) == null ? void 0 : _a3.call(l, Qa);
                      0 == Qa && (null !== Ra && (clearInterval(Ra), Ra = null), Sa && (c = Sa, Sa = null, c()));
                      return Z;
                    }
                    var b = { env: ee, wasi_snapshot_preview1: ee };
                    Qa++;
                    (_a2 = l.monitorRunDependencies) == null ? void 0 : _a2.call(l, Qa);
                    ...
                    Va || (Va = Ua("canvas_advanced.wasm") ? "canvas_advanced.wasm" : l.locateFile ? l.locateFile("canvas_advanced.wasm", ua) : ua + "canvas_advanced.wasm");
                    Za(b, function(c) {
                      a(c.instance);
                    }).catch(da);
                    return {};
                  ...
                  function ke() {
                    function a() {
                      if (!ie && (ie = true, l.calledRun = true, !Ea)) {
                        l.noFSInit || mc || (mc = true, l.stdin = l.stdin, l.stdout = l.stdout, l.stderr = l.stderr, l.stdin ? nc("stdin", l.stdin) : ic("/dev/tty", "/dev/stdin"), l.stdout ? nc("stdout", null, l.stdout) : ic("/dev/tty", "/dev/stdout"), l.stderr ? nc("stderr", null, l.stderr) : ic("/dev/tty1", "/dev/stderr"), jc("/dev/stdin", 0), jc("/dev/stdout", 1), jc("/dev/stderr", 1));
                        Nb = false;
                        fb(Na);
                        ca(l);
            ...
            (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
              ...
              __webpack_require__2.d(__webpack_exports__2, {
                ...
                registerKeyboardInteractions: () => (
                  /* reexport safe */
                  _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__.registerKeyboardInteractions
                ),
                /* harmony export */
